...
Partial Public Class NorthwindDataSet
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddCustomersRow(ByVal Company As String, ByVal Last_Name As String, ByVal First_Name As String) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow,CustomersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Company, Last_Name, First_Name}
...
Namespace NorthwindDataSetTableAdapters
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM Customers"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE  (ID = ?)"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customers` (`Company`, `Last Name`, `First Name`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE Customers"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET          Company = ?, [Last Name] = ?, [First Name] = ?"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WH"& _ 
                "ERE  (ID = ?)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Company", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Company", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Last_Name", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Last Name", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("First_Name", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "First Name", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.AccessDatabase.My.MySettings.Default.NorthwindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Company, [Last Name], [First Name] FROM Customers"
        ...
        Public Overloads Overridable Function Insert(ByVal Company As String, ByVal Last_Name As String, ByVal First_Name As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Company As String, ByVal Last_Name As String, ByVal First_Name As String, ByVal Original_ID As Integer) As Integer
            If (Company Is Nothing) Then
